  ...
  <div className="flex flex-wrap gap-6 sm:gap-8 bg-white p-4 sm:p-6 rounded-xl">
    ...
    <div className="flex flex-col flex-shrink-0 w-full md:w-1/2 xl:w-[30%]">
      <div className="flex flex-col sm:flex-row sm:space-x-4">
        ...
        <div className="flex-1 sm:mt-0 flex items-center justify-center h-64 sm:h-[400px] md:h-[450px]">
          <Image
            src="https://cdn11.bigcommerce.com/s-4jpol1blth/images/stencil/640w/products/78219/966124/41FF8B7RPNL._AC___93112.1736531700.jpg?c=1%22"
            alt="Selected Product"
            className="w-full h-full object-contain rounded-lg mt-8 lg:m-0"
            width={500}
            height={500}
          />
        </div>
    ...
    <div className="flex flex-col h-full flex-1 min-w-[20rem]">
      <div>
        ...
        <h1 className="text-xl sm:text-3xl font-semibold text-gray-900 leading-9 mb-3">
          {product.name2}
        </h1>
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:gap-4">
            ...
            <span className="text-sm sm:text-lg text-green-900">In Stock</span>
          </div>
