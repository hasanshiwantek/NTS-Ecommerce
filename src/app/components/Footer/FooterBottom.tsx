      ...
      <section className="py-6 border-b border-white-700 bg-[#585858]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-center md:text-left">
            <h4 className="text-2xl md:text-3xl font-semibold mb-2">Subscribe to our Newsletter</h4>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <nav aria-label="Categories">
            ...
            <ul className="space-y-2 text-gray-300 text-sm">
              <li><a href="#" className="hover:text-white">Hard drive</a></li>
              <li><a href="#" className="hover:text-white">SSD</a></li>
              <li><a href="#" className="hover:text-white">Routers</a></li>
              <li><a href="#" className="hover:text-white">Wifi</a></li>
              <li><a href="#" className="hover:text-white">Monitors</a></li>
              <li><a href="#" className="hover:text-white">Keyboards</a></li>
              <li><a href="#" className="hover:text-white">Webcams</a></li>
              <li><a href="#" className="hover:text-white">Printers</a></li>
            </ul>
          </nav>
          ...
          <nav aria-label="Hard Drive">
            ...
            <ul className="space-y-2 text-gray-300 text-sm">
              <li><a href="#" className="hover:text-white">HDD</a></li>
              <li><a href="#" className="hover:text-white">External Drive</a></li>
              <li><a href="#" className="hover:text-white">NAS</a></li>
              <li><a href="#" className="hover:text-white">Hybrid SSHD</a></li>
              <li><a href="#" className="hover:text-white">Portable SSD</a></li>
              <li><a href="#" className="hover:text-white">RAID array</a></li>
              <li><a href="#" className="hover:text-white">M.2 NVME</a></li>
              <li><a href="#" className="hover:text-white">SATA SSD</a></li>
            </ul>
          </nav>
          ...
          <nav aria-label="SSD">
            ...
            <ul className="space-y-2 text-gray-300 text-sm">
              <li><a href="#" className="hover:text-white">NVME</a></li>
              <li><a href="#" className="hover:text-white">M.2 SSD</a></li>
              <li><a href="#" className="hover:text-white">SATA SSD</a></li>
              <li><a href="#" className="hover:text-white">PCIe SSD</a></li>
              <li><a href="#" className="hover:text-white">SAS SSD</a></li>
              <li><a href="#" className="hover:text-white">U.2 SSD</a></li>
              <li><a href="#" className="hover:text-white">External SSD</a></li>
            </ul>
          </nav>
          ...
          <nav aria-label="Monitors">
            ...
            <ul className="space-y-2 text-gray-300 text-sm">
              ...
              <li><a href="#" className="hover:text-white">Curved</a></li>
              <li><a href="#" className="hover:text-white">4K</a></li>
              <li><a href="#" className="hover:text-white">Portable</a></li>
              <li><a href="#" className="hover:text-white">Ultra-wide</a></li>
            </ul>
          </nav>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-6 py-10">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <section aria-label="Contact Us">
            ...
            <ul className="space-y-2 text-gray-300 text-sm">
              <li><a href="mailto:contact@albatross.com" className="hover:text-white">contact@albatross.com</a></li>
              <li><a href="tel:+4122123345677" className="hover:text-white">+41 22 123345677</a></li>
            </ul>
          </section>
          ...
          <address className="not-italic">
            ...
            <p className="!text-gray-300 text-sm">123 Lakeview Avenue, Zurich</p>
