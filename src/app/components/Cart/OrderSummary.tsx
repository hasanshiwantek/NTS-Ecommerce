...
const OrderSummary = () => {
  return (
      ...
      <div className="text-sm text-gray-700 space-y-2 mb-2">
        ...
        <div className="flex justify-between py-2">
          <span className="h5-regular">
            Shipping (FedEx priority <span className="font-semibold">$370.00</span>)
          </span>
    ...
    <div className="mt-4 space-y-2"> 
                            <label htmlFor="discountCode" className="h5-regular" > Apply Discount Code </label> 
                            <div className="flex gap-2 my-2"> 
                              <Input id="discountCode" type="text" className= "xl:h-[45.5px] 2xl:h-[60px] !max-w-full " /> 
                              <button className="h4-medium border border-black px-4 rounded">Apply</button> 
                              </div>
                              </div>
     ...
     <div className="flex flex-col gap-3 mt-5">
      ...
      <button className="w-full  bg-black hover:bg-gray-900 !text-[#FFFFFF] py-5 h4-medium font-semibold rounded-lg mb-3 flex items-center justify-center gap-2 transition">
        <img src="/checkouticon/googlepay.png" alt="Google" className="w-20 h-8" />
      </button>
