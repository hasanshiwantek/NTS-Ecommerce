  ...
  >
    ...
    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full xl:w-[65.1%] 2xl:w-[64.5%]">
      ...
      <div className="w-full sm:w-[70%] xl:w-[82.1%] 2xl:w-[82%]">
        <p className="h5-medium-20px-medium text-base sm:text-lg">SKU: ZY110AY</p>
    ...
    <div
      ...
      "
    >
      <p className="h5-regular text-base sm:text-lg">${"400.00"}</p>
      ...
      >
       ...
       <div className="flex flex-col justify-center items-center border-l border-gray-300 xl:w-[51%] 2xl:w-[48.9%]"> 
        <button type="button" onClick={increase} className="flex items-center justify-center w-2.5 h-5 hover:bg-gray-100 text-[#AEAEAE]" > ▲ </button> 
        <button type="button" onClick={decrease} className="flex items-center justify-center w-2.5 h-6 hover:bg-gray-100 text-[#AEAEAE]" > ▼ </button> 
        </div>
      </div>
