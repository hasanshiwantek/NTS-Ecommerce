  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-[1920px] mx-auto py-10 px-[7%] md:px-[6%] lg:px-[5%] xl:px-[4.5%] 2xl:px-[100px] flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-[28%] xl:w-[23.6%] 2xl:w-[412px] border rounded-xl">
          <div className="bg-[#F5F6FA] p-[1.25rem] border-b">
        ...
        <div className="w-full lg:w-[68%] xl:w-[72.2%] 2xl:w-[1260px] px-[3%] md:px-[2.5%] xl:px-[2%] 2xl:px-[24px]">
          ...
          <section id="eligibility" className="scroll-mt-28">
            ...
            <p className="h5-regular leading-[28px] mb-4">
              ...
              trusted third parties for the purposes listed above, including
              payment processors, logistics providers, or IT service
              providers—always under strict data protection obligations.
            </p>
            <p className="h5-regular leading-[28px] mb-4">
              We comply with the high standards of applicable data protection
              regulations, including the General Data Protection Regulation
              (GDPR) (Regulation (EU) 2016/679). We ensure that GDPR standards
              are embedded in our daily operations when handling personal data
              of EU citizens, as required under the GDPR.
            </p>
            <p className="h5-regular leading-[28px] mb-6">
              We may also disclose personal data if required by law or to
              protect our rights, safety, or users.
            </p>
          </section>

          {/* Section: Easy Return Process */}
          <section id="easy-return" className="scroll-mt-28">
            ...
            <ul className="list-disc pl-6 h5-regular space-y-[14px] mb-6">
              ...
              <li>
                From third-party partners who help us support your business
                needs.
              </li>
              <li>
                Directly from you, when you register, request a quote, place an
                order, or contact us.
              </li>
            </ul>
          </section>
          ...
          <section id="restocking" className="scroll-mt-28">
            <h3 className="h2-medium mb-3 text-[#4A4A4A]" id="restocking">
              Restocking Fees
            </h3>
            <p className="h5-regular leading-[28px] mb-6">
              We value your feedback and are always looking to improve our
              policies and services. If you have any suggestions or comments on
              how we can enhance your shopping experience, please don't hesitate
              to reach out. Your insights are crucial for us to better serve you
          ...
          <section id="shipping-charges" className="scroll-mt-28">
            <h3 className="h2-medium mb-3 text-[#4A4A4A]" id="return-shipping">
              Return Shipping Charges
            </h3>
            <p className="h5-regular leading-[28px] mb-6">
              We value your feedback and are always looking to improve our
          ...
          <section id="non-returnable" className="scroll-mt-28">
            ...
            <p className="h5-regular leading-[28px] mb-4">
              Some items may be considered
              <span className="italic">"final sale"</span>, making them
              unsuitable for exchange or refund. As per our policy, we
              diligently designate such things on our website and do not accept
              returns for them.
            </p>
            <p className="h5-regular leading-[28px]">
              We prioritize your pleasure and work to tailor our policies to
              meet your needs. Do not hesitate to get in touch with us if you
              need any additional information or support.
            </p>
          </section>
        </div>
      </div>
